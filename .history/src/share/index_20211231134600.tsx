 ...
 * @LastEditors: lzj
 * @LastEditTime: 2021-12-31 13:45:51
...
export default (props:ShareProps) => {
  ...
  const templates = {
    QZone : `https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=${url}&sharesource=qzone&title=${title}&pics=${pics}&summary=${summary}`
  }
